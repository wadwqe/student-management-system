    ...
    public static void admin_window() {
        ...
        addCourseButton.addActionListener(e -> {
            ...
            if (result == JOptionPane.OK_OPTION) {
                ...
                Administrator.addLesson(courseNameString, courseStarTimeInt, courseEndTimeInt, cycleInt, courseLocationInt, courseOnlineBoolean, courseOnlinePlatformString, courseOnlineLinkString);
            }
        });
        ...
        addExamButton.addActionListener(e -> {
            ...
            JTextField examTime = new JTextField(20);
            ...
            myPanel.add(Box.createHorizontalStrut(15)); // a spacer
            myPanel.add(new JLabel("考试时间:"));
            myPanel.add(examTime);
            myPanel.add(Box.createHorizontalStrut(15)); // a spacer
            ...
            int result = JOptionPane.showConfirmDialog(null, myPanel,
                    "请输入考试信息", JOptionPane.OK_CANCEL_OPTION);
            if (result == JOptionPane.OK_OPTION) {
                String examNameString = examName.getText();
                String examTimeString = examTime.getText();
                ...
                //Administer.addExam(examNameString,examTimeString,examLocationString,examOnlineString,examOnlinePlatformString,examOnlineLinkString);
            }
        });
